...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1>Ingrediants List</h1>
				</div>
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="{{ url('admin/home') }}">Home</a></li>
						<li class="breadcrumb-item active">Ingrediants</li>
					</ol>
				</div>
			</div>
		</div><!-- /.container-fluid -->
				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-header">
							...
							<button class="btn btn-info pull-right" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus-circle"></i> Add Ingrediant</button>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
							<table class="table table-bordered">
								...
								<tbody>
									...
									@empty
									<tr>
										<td colspan="3">No Ingrediant Availble</td>
									</tr>
									@endforelse
								</tbody>
							</table>
						...
						<div class="card-footer clearfix">
							<div class="pull-right">{!! $ingrediants->links() !!}</div>
						</div>
					</div>
					<!-- /.card -->
				</div>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">Add Ingrediants Item</h5>
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="card card-info">
										<div class="card-header">
											<h3 class="card-title">Add Ingrediants</h3>
										</div>
										<!-- /.card-header -->
										<!-- form start -->
